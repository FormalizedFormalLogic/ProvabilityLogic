...
SeqPL's semantics of `LogicD` (`LogicD.provability_TFAE`) produces countermodels of the
shape `M.toPseudoTail r o`, whereas the simplification machinery of [Bek90] §4
(Lemma 8, `SeqPL/Kripke/Simplification.lean`) operates on ω-models of the shape
